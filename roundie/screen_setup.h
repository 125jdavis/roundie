...
static lv_obj_t *createSetupScreen(void) {
    ...
    lv_obj_set_style_text_font(s_lblSetupTitle, &lv_font_montserrat_28, 0);
    ...
    lv_obj_set_style_text_font(lblMetric, &lv_font_montserrat_24, 0);
    ...
    lv_obj_set_style_text_font(lblMerican, &lv_font_montserrat_24, 0);
    ...
    lv_obj_set_style_text_font(s_lblSetupHint, &lv_font_montserrat_14, 0);
